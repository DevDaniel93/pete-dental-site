...
export function My_account() {
  ...
  const base_url =
    "https://custom3.mystagingserver.site/Pete-Cardamone-Dental/public/";
                            ...
                            <div className="col-lg-12">
                              <div className="row mb-4">
                                ...
                                <div className="col-xl-4 col-lg-6 mb-3">
                                  <h4 className="secondaryLabel">
                                    {" "}
                                    Dental board_of California License number{" "}
                                  </h4>
                                  <p className="secondaryText">
                                    {
                                      profile?.data
                                        ?.dental_board_of_california_license_number
                                    }
                                  </p>
                                </div>
                                ...
                                <div className="col-xl-4 col-lg-6 mb-3">
                                  ...
                                  <p className="secondaryText">
                                    {profile?.data?.legal_office_name}
                                  </p>
                                </div>
                                ...
                                <div className="col-xl-4 col-lg-6 mb-3">
                                  ...
                                  <p className="secondaryText">
                                    {profile?.data?.bussiness_address}
                                  </p>
                                </div>
                              </div>
                            </div>
                                  ...
                                  <div className="row justify-content-center  align-items-center py-4 ">
                                    <div className="col-md-2">
                                      <div className="wish text-center">
                                        <img
                                          src={
                                            baseurl + item?.product_detail?.src
                                          }
