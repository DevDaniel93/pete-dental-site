...
import { Order_history } from '../Screen/Order_history'
import { ProtectedRoutes } from "./protect_route";
import { Wish_List } from '../Screen/Wishlist'
...
export default function AdminRouter() {
  ...
  */}
        ...
        <Route path="/checkout" element={<ProtectedRoutes Components={Checkout} />}  />
 
   
        <Route path="/order-history/:id" element={<Order_history/>} />
        <Route path="/wish-lish/:id" element={<Wish_List/>} />
